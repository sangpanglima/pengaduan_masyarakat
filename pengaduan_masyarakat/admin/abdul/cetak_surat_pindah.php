...
<body>
    <div>
        <div class="container">
            ...
            <div class="isi-surat">
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan di bawah ini, Kepala Desa Sumber Makmur, Kecamatan Tapung, Kabupaten Kampar, dengan ini menerangkan bahwa pemohon di bawah ini:</p>
            </div>
            ...
            <div class="ttd-section">
                ...
                <div class="nama-pejabat">H. Basroni</div>
            </div>
        </div>
