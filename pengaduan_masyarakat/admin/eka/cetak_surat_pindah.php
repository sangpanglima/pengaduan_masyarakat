...
<body>
    <div>
        <div class="container">
            <div class="kop-surat">
                <img src="../../img/lawas.png" alt="Logo Kabupaten" class="logo">
                <div class="text-container">
                    <h2>PEMERINTAH KABUPATEN PADANG LAWAS</h2>
                    <h3>KECAMATAN HUTARAJA TINGGI</h3>
                    <p>Jalan Pembangunan No. 1, Kode Pos: 22776, Telp: (021) 123-4567</p>
                </div>
            </div>
            ...
            <div class="isi-surat">
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Yang bertanda tangan di bawah ini, Kepala Desa Pir Trans Sosa VI, Kecamatan Hutaraja Tinggi, Kabupaten Padang Lawas, dengan ini menerangkan bahwa pemohon di bawah ini:</p>
            </div>
            ...
            <div class="ttd-section">
                <span>Kabupaten Padang Lawas, <?php echo $tanggal_surat; ?></span><br>
                <span>Kepala Desa Pir Trans Sosa VI</span>
                <div class="nama-pejabat"></div>M. Arnandes Firnando
        </div>
